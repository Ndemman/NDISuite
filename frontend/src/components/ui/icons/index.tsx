...
export function MicIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg 
...
export function FileCheckIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 
...
export function SquareIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 
