...
import { formatDate, getRelativeTimeFromNow } from '@/utils/dateUtils';
          ...
          <div className="p-4 border-b border-border/40 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`p-1 rounded ${viewMode === 'list' ? 'bg-primary/10 text-primary' : 'hover:bg-muted/30'} focus:ring-2 focus:ring-primary focus:outline-none`}
              ...
              <button
                ...
                className={`p-1 rounded ${viewMode === 'grid' ? 'bg-primary/10 text-primary' : 'hover:bg-muted/30'} focus:ring-2 focus:ring-primary focus:outline-none`}
                      ...
                      <tr key={report.id} className="hover:bg-muted/20 cursor-pointer transition-colors" onClick={() => handleOpenReport(report.id)}>
                        ...
                        <td className="px-3 py-4 truncate text-sm">
                          <div className="flex items-center">
                            ...
                            <span className="truncate">{getRelativeTimeFromNow(report.lastUpdated)}</span>
                          </div>
                        </td>
                  ...
                  >
                    ...
                    <div className="mt-3 space-y-2">
                      ...
                      <div className="flex items-center text-sm">
                        ...
                        <span>Updated {getRelativeTimeFromNow(report.lastUpdated)}</span>
                      </div>
