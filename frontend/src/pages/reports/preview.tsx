          ...
          <div className="bg-gray-100 p-6 border-b border-gray-300">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
              <div>
                ...
                <p className="text-gray-600 mt-1">Date: {formatDateWithMonthName(report.date)}</p>
              </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{formatDateWithMonthName(report.clientDetails.dateOfBirth)}</p>
                </div>
                <div>
